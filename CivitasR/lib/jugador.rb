...
module Civitas
  class Jugador
      ...
      if(@encarcelado)
        ...
        if(existe_la_propiedad())
          if(@propiedades.at(ip).vender(self))
            ...
            Diario.ocurre_evento("Se ha vendido la propiedad: "+@propiedades.at(ip).to_s)
            return true
          end
        end
      end
    ...
    def main
      ...
      puts("CASA CONSTRUIDA: " + jugador.propiedades.get(0).construir_casa(jugador).to_s)
      puts("CASA CONSTRUIDA: " + jugador.propiedades.get(0).construir_casa(jugador).to_s)
      puts("CASA CONSTRUIDA: " + jugador.propiedades.get(0).construir_casa(jugador).to_s)
      puts("CASA CONSTRUIDA: " + jugador.propiedades.get(0).construir_casa(jugador).to_s)
      ...
      puts("HOTEL CONSTRUIDO: " + jugador.propiedades.get(0).construir_hotel(jugador).to_s)
      ...
      sorpresa = Sorpresa.new("Auxiliar")
      ...
      puts("Debe dar false, no debe ser encarcelado: " + jugador.debe_ser_encarcelado().to_s)
      ...
      puts("Debe dar 4, estamos en la carcel: " + jugador.num_casilla_actual.to_s)
        
      puts("Debe dar 200 de precio de libertad: " + jugador.precio_libertad.to_s)
        
      puts("Debe dar 1000 de premio de salida: " + jugador.premio_paso_salida.to_s)
      ...
      puts("Debe dar false, no puede salir pagando si no esta en la carcel: " + jugador.salir_carcel_pagando().to_s)
      ...
      jugador.obtenerSalvoconducto(sorpresa.sorpresa_mazo(Tipo_Sorpresas::SALIR_CARCEL , mazo))
        
      puts("Debe dar true, tiene salvoconducto: " + jugador.tiene_talvoconducto().to_s)
        
      jugador.perder_salvoconducto()
        
      puts("Debe dar false, no tiene salvoconducto: " + jugador.tiene_talvoconducto().to_s)
      ...
      puts("Debe dar false, no puede salir pagando: " + jugador.salir_carcel_pagando().to_s)
      ...
      puts("Debe dar true en algun momento: " + jugador.salir_carcel_tirando().to_s)
      puts("Debe dar true en algun momento: " + jugador.salir_carcel_tirando().to_s)
      puts("Debe dar true en algun momento: " + jugador.salir_carcel_tirando().to_s)
      puts("Debe dar true en algun momento: " + jugador.salir_carcel_tirando().to_s)
      puts("Debe dar true en algun momento: " + jugador.salir_carcel_tirando().to_s)
  ...
  Test_jugador = Jugador.new("Ramón")
  Test_jugador.main()
